* A project has been created in /tmp/tmpmUSKB5.

* A minilay has been installed in /tmp/tmpmUSKB5/minilays/mars.
...
* The project must be archived here 'http://hg.foo.net' using 'hg' or change the minibuild src_uri/scm_type.
